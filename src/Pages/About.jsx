                ...
                <div>
                    ...
                    <div className="min-h-screen bg-[#FFF8EE] overflow-hidden md:mt-64">
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-0 mx-auto p-4 md:p-10 w-full max-w-screen-xl">
                            ...
                            <div
                                className="h-[60vw] md:h-full w-full md:w-1/2 flex flex-col gap-6 px-4 py-4 md:px-8 md:py-0"
                                data-aos="fade-left"
                            >
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-0 p-4 md:p-10 w-full max-w-screen-xl">
                            <div className="h-[60vw] md:h-full w-full md:w-1/2 rounded-[20px] overflow-hidden" data-aos="fade-right">
                                <img
                                    className="h-full w-full object-cover"
                                    src="https://www.shutterstock.com/image-photo/group-friends-meeting-restaurant-posing-260nw-2349014265.jpg"
                                    alt="Image"
                                />
                            </div>
                            <div
                        ...
                        <div className="md:mt-2 mt-24 px-4 md:px-16 md:flex items-center justify-center w-full bg-[#FFDFDF]">
                            <div className="w-full md:w-1/2" data-aos="fade-left">
                                ...
                                <h2 className="text-2xl text-[#2A435D] font-bold text-center md:text-left">Our Chef</h2>
